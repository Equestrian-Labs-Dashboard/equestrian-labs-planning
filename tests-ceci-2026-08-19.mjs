...
assert.match(index, /assets\/js\/app\.js\?v=2153/, 'Index must bust cache for integrated app.js');
assert.equal(assumptions.meta.version, '2.15.3', 'Assumptions version must match integrated model');
...
console.log('PASS cache-busted integrated app.js v2.15.3');
